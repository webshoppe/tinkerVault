...
| **Dossier** (v1.0.3) | Portable, offline dossier workspace for Windows: documents, notes, sticky notes, paint, kanban, annotate, and a decision timeline, plus full-text search and an optional local agent panel. Native compiled `.exe`, not a browser app | [Download](https://github.com/webshoppe/tinkerVault/releases/tag/dossier-v1.0.3) | [`apps/dossier/`](apps/dossier/) |
...
- Dossier: [1.0.3](apps/dossier/) current (first public release, no earlier archived version)
...
│   └── dossier/  (currently v1.0.3, compiled Windows .exe, not a browser app)
│       └── releases/
│           └── 1.0.3/  (duplicate of current, kept as a snapshot; first release, nothing archived yet)
├── docs/
│   └── PHILOSOPHY.md
├── DESKTOP-LAUNCHER.md
├── LICENSE
