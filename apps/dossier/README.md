...
See [releases/1.0.3/STATUS.md](./releases/1.0.3/STATUS.md) for the current version's verification.
...
| [releases/1.0.3/STATUS.md](./releases/1.0.3/STATUS.md) | Latest packaging verification |
...
- WebView2 Runtime: Microsoft (system component). Also vendors a locally-patched [go-webview2](./third_party/go-webview2/) (MIT) and Microsoft's WebView2Loader SDK (BSD-style redistribution license); both LICENSE files are included alongside the code.
